  ...
  faq: [
    {
      ...
      a: "当番制はありません。より多くのご家庭が気軽に参加できるよう、当番制はなくなりました。ただし夏季練習のサポートや試合の引率など、無理のない範囲でご協力いただく場合があります。",
    },
    {
      q: "道具は最初から全部揃えないといけませんか？",
      a: "まずは動きやすい服装と運動靴だけでOKです。グローブやバットは上の学年のお下がりが回ってくることもあります。入団後に少しずつ揃えていただければ大丈夫です！",
    },
    {
      q: "野球未経験でも大丈夫ですか？",
    ...
    {
      q: "会費・入会金はいくらですか？",
      a: "年間7,000円（うち1,000円は保険代）です。入会金はありません。体験会への参加は無料です。",
    },
    {
      q: "体験はいつでも来られますか？",
